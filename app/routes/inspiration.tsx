	...
	return (
		<Layout title={'be inspired'}>
			<div className="relative mx-4 my-8 flex flex-col gap-4">
				<div className="bg-blue-400 p-6 text-gray-800 font-accent shadow-lg">
					<blockquote className="pb-4 leading-relaxed text-2xl">
						If my people, who are called by my name, will{' '}
						<span className="bg-white py-3 px-1">humble</span>{' '}
						themselves and pray and seek my face and turn from their
						wicked ways, then I will hear from heaven, and I will{' '}
						<span className="bg-white py-3 px-1">
							forgive their sin
						</span>{' '}
				...
				<div className="bg-blue-700 p-6 text-gray-100 font-accent shadow-lg">
					<blockquote className="pb-4 leading-relaxed text-2xl">
						Cast all your anxiety on him because{' '}
						<span className="bg-gray-500 py-3 px-1">
							he cares for you.
						</span>
					</blockquote>
