...
import { ColorModeScript, cookieStorageManagerSSR, localStorageManager } from "@chakra-ui/react";
...
const Document = withEmotionCache(({ children, title, cookies, ENV }: DocumentProps, emotionCache) => {
